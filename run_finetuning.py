...
from dataloaders.vist import VistDataset
...
def load_and_cache_vist_examples(args, tokenizer):
    dataset = VistDataset(
...
def main():
    ...
    parser.add_argument("--data_dir", default='data/vist/', type=str,
                        help="Directory containing train, val, test files")
    parser.add_argument("--output_dir", default='experiments/image_inference/', type=str,
    ...
    # Get Dataset Loader
    dataset = load_and_cache_vist_examples(
        args,
        tokenizer
    )
